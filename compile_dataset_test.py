...
if __name__ == '__main__':
    struct = {
        'features': [
            ('raw_mean_std_normalized_test', SimpleTransform()),
            ('raw_mean_std_normalized_smoothed_uniform200_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
            ('raw_mean_std_normalized_test', SimpleTransform()),
            ('raw_mean_std_normalized_smoothed_gaussian50_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
            ('detrend_gaussian10_test', SimpleTransform()),
            ('raw_mean_std_normalized_smoothed_gaussian50_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
            ('detrend_gaussian5_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
            ('detrend_gaussian15_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
            ('fft_smoothed_sigma10_test', SimpleTransform()),
        ],
    }
    ...
    struct = {
        'features': [
             ('fft_smoothed_sigma20_test', SimpleTransform()),
        ],
    }
