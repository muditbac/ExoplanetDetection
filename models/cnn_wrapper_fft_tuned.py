...
def create_model(dropout1=0.5, dropout2=0.5, lr=0.000353794026714):
    model = Sequential()
    ...
    model.compile(optimizer=Adam(lr=lr, decay=2e-4), loss='binary_crossentropy', metrics=['accuracy'])
    return model
