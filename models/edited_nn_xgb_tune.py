...
steps = [
    ...
    ('xgb', xgb.XGBClassifier(n_estimators=1000, colsample_bytree=0.55, subsample=0.8175, min_child_weight=2.0, learning_rate=0.009186, gamma=1.196186, max_depth=21, silent=True, nthread=3, seed=random_seed))
]
